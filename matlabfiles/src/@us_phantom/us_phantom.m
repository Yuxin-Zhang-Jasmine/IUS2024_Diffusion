classdef us_phantom < handle
    ...
    methods (Access = public)
        ...
        function h = us_phantom(input_name)
            ...
            h.zLimits = 0;
            h.bckDensity = 20;
            h.occlusionCenterX = [-7; 7; -7; 7]./1000;
            h.occlusionCenterZ = [20; 20; 40; 40]./1000;
            h.occlusionDiameter =[3; 3; 3; 3]./1000;
            h.RoiCenterX = 0;
            h.RoiCenterZ = 0;
            h.RoiPsfTimeX = 0;
            h.RoiPsfTimeZ = 0;
            ...
            h.mode = 0;
            h.xPts = [-12; 0; 12; -12; 0; 12]./1000;
            h.zPts = [15; 15; 15; 40; 40; 40]./1000; 
    ...
    methods  
        ...
        function set.zPts(h,input_zPts)
            assert(isnumeric(input_zPts), 'Wrong format of the z-axis point scatterers zPts. It should be a numeric vector in (m)');
            h.zPts = input_zPts;
        end
        %-- xLimits
