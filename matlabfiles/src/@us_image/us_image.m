classdef us_image < handle
    ...
    properties  (SetAccess = public)
        ...
        postenv                     %-- scalar 0 or 1 controlling whether ot not envelope(Bmode,1,'peak')
    ...
    methods (Access = public)
        ...
        function write_file_hdf5(h,filename)
            ...
            %-- postenv
            dset_details.Location = location;
            dset_details.Name = 'postenv';
            hdf5write(filename, dset_details, single(h.postenv), 'WriteMode', 'append');
                ...
                case 'v.0.0.40'
                    ...
                    for n=1:length(info.Groups)
                        ...
                        if strcmp(dstype,'SR')
                            ...
                            %--postenv
                            h.postenv = h5read(filename,[location '/postenv']);
        ...
        function write_file_mat(h,filename)
            ...
            %-- postenv
            PARAM.postenv = single(h.postenv);
